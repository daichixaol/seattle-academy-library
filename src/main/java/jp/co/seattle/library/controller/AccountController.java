...
public class AccountController {
	...
	public String createAccount(Locale locale,
		...
		boolean validCheck = password.matches("^[a-zA-Z0-9]{8,}$");
		if (!validCheck) {
			model.addAttribute("validError","パスワードは8文字以上かつ半角英数字に設定してください。");
			return "createAccount";
		}
		boolean passwordCheck = password.equals(passwordForCheck);
		if (!passwordCheck) {
